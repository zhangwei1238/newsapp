<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"D:\wamp\www\app\public/../application/admin\view\news\add.html";i:1508900885;s:66:"D:\wamp\www\app\public/../application/admin\view\public\_meta.html";i:1508335144;s:68:"D:\wamp\www\app\public/../application/admin\view\public\_footer.html";i:1508393175;}*/ ?>
<!--header-->
<!DOCTYPE HTML>
<html>
<head>
  ...
  <form class="form form-horizontal" id="form-singwaapp" url="<?php echo url('news/add'); ?>">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9 skin-minimal">
        <div class="check-box">
          <input type="checkbox" id="is_allowcomments" name="is_allowcomment" value="1">
  ...
  $(function(){
    ...
    $("#form-singwaapp").validate({
      ...
      submitHandler:function(form){
        weierapp_save(form);// 需要小伙伴自定义一个singwaapp_save方法 用来处理抛送请求的哦
      }
    });
